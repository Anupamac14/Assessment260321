...
public class Company {
	public static void main(String args[]) {
		...
		list1.add(new Employee(104,"Netty",Employee.Status.CONFIRMED));
		list1.add(new Employee(103,"Buff",Employee.Status.FAILED));
		list1.add(new Employee(102,"Racchu",Employee.Status.PENDING));
